...
- On the backside of the circuit board below the battery case, solder two wires on the soldering spots of the sync red button (it will be triggered by the relay) and two wires on soldering spots of the +/- power supply (Batteries terminals)
